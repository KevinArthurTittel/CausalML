...
run_method = function(numtrees, index, lambdas, boolean.plot, boolean.lambdas) {
  ...
  results_ATE <- basic.results
    ...
    rownames(results_ATE) <- c("within 8 weeks of due date", "within 24 weeks of due date", "within 52 weeks of due date",
...
results_table3 <- list('Sheet1' = results[["results_ATE"]])
write.xlsx(results_table3, file = "Table 3 (Field et al., 2013).xlsx")
